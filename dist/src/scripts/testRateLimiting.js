...
class RateLimitingTester {
    results = [];
    log(message, success = true, details) {
    ...
    `;
        ...
        const result1 = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        const result2 = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
        ...
        const result3 = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
exports.default = RateLimitingTester;
//# sourceMappingURL=testRateLimiting.js.map