...
class CSRFProtectionTester {
    ...
    async testCSRFTokenEndpoint() {
        ...
        try {
            const response = await (0, node_fetch_1.default)(CSRF_ENDPOINT);
    ...
    async testSensitiveOperationProtection() {
        ...
        let csrfToken = '';
        try {
            const tokenResponse = await (0, node_fetch_1.default)(CSRF_ENDPOINT);
        ...
        for (const mutation of sensitiveMutations) {
            ...
            const responseWithoutToken = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Origin': 'http://localhost:3000'
            ...
            const responseWithToken = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Origin': 'http://localhost:3000',
    ...
    async testRefererHeaderProtection() {
        ...
        const responseWithReferer = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
        ...
        const responseWithAllowedReferer = await (0, node_fetch_1.default)(GRAPHQL_ENDPOINT, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
exports.default = CSRFProtectionTester;
...
//# sourceMappingURL=testCSRF.js.map